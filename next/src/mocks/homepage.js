export const homepageMock = {
  ...
  dynamic_zone: [
    ...
    // {
    //   __component: "dynamic-zone.process-circles",
    //   id: 12,
    //   Title: "From Script to Adherence",
    //   Subtitle:
    //     "Cinnamon is a complete medication access ecosystem—integrating AI-powered prior authorization, foundation and co-pay support, patient assistance, charity care, and adherence solutions into one streamlined platform.",
    //   Process_circles: [
    //     { id: 34, Title: "Prior Authorization", Icon: { url: "/uploads/shield_tick_7ec1eff0b7.svg" } },
    //     { id: 35, Title: "Patient Assistance", Icon: { url: "/uploads/headphone_7b446c5353.svg" } },
    //     { id: 36, Title: "Patient Adherence", Icon: { url: "/uploads/task_square_a138fbc97e.svg" } },
    //   ],
    // },
    {
          ...
          Text: [
            {
              ...
              children: [
                { type: "text", text: "A " },
                { type: "text", text: "financial EHR overlay", bold: true },
          ...
          Text: [
            {
              ...
              children: [
                ...
                { type: "text", text: "cut time-to-therapy", bold: true },
              ],
            },
          ],
        },
    ...
    // >>> NEW: prefooter-home
    {
      __component: "dynamic-zone.prefooter-home",
      id: 22,
      Title: "Engineered <strong>Advantages</strong>",
      Text: [
        {
          type: "paragraph",
          children: [
            { type: "text", text: "Real-time connection ", bold: true },
            { type: "text", text: "to the health-system EHR" }
          ],
        },
        {
          type: "paragraph",
          children: [
            { type: "text", text: "FHIR-based pipelines", bold: true },
            { type: "text", text: " for EHR data requests" }
          ],
        },
        {
          type: "paragraph",
          children: [
            { type: "text", text: "Coverage Waterfall ", bold: true },
            { type: "text", text: "that benefits health systems and patients" }
          ],
        },
      ],
    },
