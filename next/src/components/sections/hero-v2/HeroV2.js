    ...
    return (
        <section className={styles.heroV2}>
            ...
            <div className={`container ${styles.heroV2Inner}`}>
                <h1 className={styles.heroV2Title}>Smart <br /><em>Financial Assistance</em></h1>
                <div className={styles.heroV2Text}>Automated, compliant support that lowers costs and improves adherence.</div>
