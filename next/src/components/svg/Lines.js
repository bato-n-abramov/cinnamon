...
export function LineOne({ className, id }) {
  return (
    <svg className={className} width="155" height="214" viewBox="0 0 155 214" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <RevealMask id={id} duration={1.0} />
      </defs>
...
export function LineTwo({ className, id }) {
  return (
    <svg className={className} width="152" height="12" viewBox="0 0 152 12" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <RevealMask id={id} duration={1.0} />
      </defs>
